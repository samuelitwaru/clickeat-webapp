    ...
    <div class="d-flex justify-center">
      <v-chip-group active-class="primary--text">
        <v-chip
          ...
          @click="getDrinksByCategory(category.sub_category_id)"
...
export default {
      ...
      drinks: [
        {
          ...
          price: 20000,
          discount: 20,
          image: require("@/assets/soda.jpeg"),
        },
        {
          name: "Wine",
          description: "",
  ...
  methods: {
    getCategories() {
      this.$http
        .get(`${this.$apiUrl}/drinks_sub_cat?platform=web`)
        .then((response) => {
    ...
    getDrinksByCategory(categoryId) {
      ...
      this.$http.get(
        `${this.$apiUrl}/drinks_based_on_sub_cat/${categoryId}?platform=web`
      )
      .then((response) => {
